    ...
    <div className="max-w-5xl mx-auto p-6 bg-white rounded-xl shadow-md">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          ...
          <button
            type="submit"
            className="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-md font-semibold transition cursor-pointer"
          >
            🚀 Upload
          </button>
        </div>
