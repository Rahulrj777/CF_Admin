...
const AdminPhotographyDiploma = () => {
  ...
  return (
    <div className="p-6">
      <h2 className="text-2xl font-bold mb-6">📸 Admin Photography Diploma</h2>
      ...
      <div className="bg-white shadow rounded-xl p-6 mb-8">
        ...
        {pdfFile ? (
          ...
          <p className="text-sm text-gray-500 mb-2">
            Choose a PDF, then click Save PDF. Uploading a new PDF will replace the existing one.
          </p>
        )}
      ...
      <div className="bg-white shadow rounded-xl p-6 mb-8">
        <input
          type="text"
          placeholder="Parent Title (e.g. Month 1)"
          value={title}
        ...
        {children.map((child, index) => (
          <div key={index} className="flex items-center gap-2 mb-2">
            <input
              type="text"
              placeholder={`Child para ${index + 1}`}
              value={child}
...
export default AdminPhotographyDiploma
