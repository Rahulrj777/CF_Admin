...
const DirectionMentor = () => {
  ...
  const handleUpload = async () => {
    ...
    try {
      await axios.post(`${API_BASE}/directionmentor/upload`, formData, {
  ...
  const handleDelete = async (publicId) => {
    ...
    try {
      await axios.delete(
        `${API_BASE}/directionmentor/${encodeURIComponent(publicId)}`
      );
...
export default DirectionMentor;
