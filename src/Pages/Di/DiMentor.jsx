...
const DiMentor = () => {
  ...
  // Delete DI Mentor with confirmation
  const handleDelete = async (publicId) => {
    ...
    try {
      await axios.delete(
        `${API_BASE}/dimentor/${encodeURIComponent(publicId)}`
      );
    ...
    <div className="p-8 max-w-5xl mx-auto bg-white rounded-2xl shadow-lg">
      ...
      <div className="mb-10 bg-gray-50 p-6 rounded-xl shadow-inner">
        ...
        <button
          ...
          className="w-full md:w-auto px-6 cursor-pointer py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition font-semibold"
        >
          🚀 Upload Mentor
        </button>
      </div>
