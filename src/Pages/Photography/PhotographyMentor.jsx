...
const PhotographyMentor = () => {
  ...
  const fetchMentors = async () => {
    try {
      const res = await axios.get(`${API_BASE}/photographymentor`);
      const mentorData = res.data?.photography?.mentor || [];
  ...
  const handleUpload = async () => {
    ...
    try {
      const res = await axios.post(
        `${API_BASE}/photographymentor/upload`,
        formData,
        {
...
export default PhotographyMentor;
